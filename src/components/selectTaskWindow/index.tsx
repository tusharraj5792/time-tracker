...
const SelectTaskWindow = forwardRef(({ children = 'root-portal', el = 'div' }: any, ref) => {
  ...
  useEffect(() => {
    ...
    const screenOptions = `left=750,top=0,width=550px,height=180px`;
...
export default SelectTaskWindow;
