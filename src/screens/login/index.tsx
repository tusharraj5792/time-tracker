...
export const Login = () => {
  ...
  return (
    <div className='container-fluid main-container'>
      {/* <!-- Logo --> */}
      <div className='mt-4'>
        <img src='./ensuesoft.jpg' alt='Logo' className='img-fluid d-block mx-auto' />
      </div>
      {/* <!-- welcome msg --> */}
      ...
      <div className='p-4'>
        <form onSubmit={handleSubmit(onSubmit)}>
          {/* <!-- email --> */}
          <div className='mb-1'>
            <label htmlFor='userEmail' className='form-label text-secondary fw-normal mb-1'>
              Email
            </label>
            <br />
            <input
          ...
          <div className='mb-1 mt-2'>
            <div className='d-flex justify-content-between align-items-start'>
              <label htmlFor='password' className='form-label text-secondary fw-normal'>
                Password
              </label>
            </div>
            <input
